...
//        byte[] byteArray = productService.getProductImage(id);
//        if(byteArray != null) {
...
//        }
    ...
    public ResponseEntity<String> updateProduct(@PathVariable int id, @RequestPart Product product, @RequestPart MultipartFile imageFile) throws IOException {
          ...
          if(product1 != null){
              ...
              return new ResponseEntity<>("Product Updated Failed", HttpStatus.INTERNAL_SERVER_ERROR);
          }
    }
    ...
    public ResponseEntity<String> deleteProduct(@PathVariable int id) {
        ...
        if(product1 != null){
            ...
            return new ResponseEntity<>("Product is Missing", HttpStatus.NOT_FOUND);
        }
    }
